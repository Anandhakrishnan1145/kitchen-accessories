...
<head>
    ...
    <title>Kitchen Accessories Stores - All Products</title>
    ...
    <style>
        ...
        .material-badge:hover, .material-badge.active {
            background-color: var(--primary-color);
            color: white;
        }
    </style>
...
<body>
    ...
    <div class="container py-5">
        <div class="text-center mb-5">
            <h2 class="page-title display-4 mb-4">All Kitchen Accessories Stores</h2>
        ...
        <div class="row">
            ...
            <?php
                ...
                echo '<div class="col-12"><div class="alert alert-info text-center">No products available at the moment.</div></div>';
            endif;
            ?>
        </div>
    </div>
