...
// Build the product query based on selected category
if (!empty($selectedCategory)) {
    $query = "SELECT p.*, a.agency_name 
              FROM products p 
              LEFT JOIN agencies a ON p.agency_id = a.id 
              WHERE p.product_category = ? AND p.status = 'active' AND p.is_visible = 1
...
// Flush the output buffer before sending HTML
ob_end_flush();
?>
...
<head>
    ...
    <title><?= !empty($selectedCategory) ? htmlspecialchars($selectedCategory) . ' - ' : '' ?>Kitchen Accessories Stores</title>
    ...
    <div class="container py-5">
            ...
            <div class="category-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?= htmlspecialchars($selectedCategory) ?></li>
                    </ol>
                </nav>
            </div>
        <?php endif; ?>
        ...
        <div class="text-center mb-5">
            <h2 class="page-title display-4 mb-4">
                <?= !empty($selectedCategory) ? htmlspecialchars($selectedCategory) : 'Kitchen Accessories Stores' ?>
            </h2>
            <p class="lead text-muted">
                <?= !empty($selectedCategory) 
                    ? "Premium $selectedCategory for your kitchen" 
        ...
        <div class="row">
            ...
            <?php
                ...
                echo '<div class="col-12"><div class="alert alert-info text-center">No products available' . (!empty($selectedCategory) ? ' in this category' : '') . ' at the moment.</div></div>';
            endif;
            ?>
        </div>
    </div>
